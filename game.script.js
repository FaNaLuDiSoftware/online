...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const tablerosBackground = {
        'rival1-boton': 'url(imagenes/tablero1.JPG)',
        'rival2-boton': 'url(imagenes/tablero2.JPG)', 
        'rival3-boton': 'url(imagenes/tablero3.JPG)',
        'rival4-boton': 'url(imagenes/tablero4.JPG)'
    };
        ...
        ficha.addEventListener('click', function() {
            ...
            setTimeout(() => {
                if (this.classList.contains('seleccionada')) {
                    // Aquí puedes agregar lógica adicional para cuando una ficha es seleccionada
